...
public class LandRoverController implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            String query = "SELECT mark, model, year, mileage, engine_capacity, transmission, drive, hand_drive, fuel, price FROM car WHERE mark = 'land rover'";
            ...
            Logger.getLogger(LandRoverController.class.getName()).log(Level.SEVERE, null, e);
        }
