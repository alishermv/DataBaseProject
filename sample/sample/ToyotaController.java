...
public class ToyotaController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            String query = "SELECT mark, model, year, mileage, engine_capacity, transmission, drive, hand_drive, fuel, price FROM car WHERE mark = 'toyota'";
            ...
            Logger.getLogger(ToyotaController.class.getName()).log(Level.SEVERE, null, e);
        }
